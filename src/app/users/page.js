  ...
  useEffect(() => {
    return createGsapContext(showcaseRef, (gsap) => {
      ...
      mm.add("(min-width: 768px)", () => {
        ...
        timeline
          .to(rows[0], { autoAlpha: 0, yPercent: -10 }, 0.65)
          .to(rows[1], { autoAlpha: 1, yPercent: 0 }, 0.65)
          .to(rows[1], { autoAlpha: 0, yPercent: -10 }, 1.45)
          .to(rows[2], { autoAlpha: 1, yPercent: 0 }, 1.45);
      });
