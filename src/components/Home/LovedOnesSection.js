    ...
    <section ref={sectionRef} className="bg-white py-12 md:py-20">
      ...
      <div className="mx-auto mt-12 flex w-full max-w-4xl justify-center px-4 md:px-8">
        <div className="loved-diagram relative h-[340px] w-full max-w-[420px]">
          <div className="absolute left-1/2 top-1/2 h-[42px] w-[2px] -translate-x-1/2 -translate-y-[102px] bg-[#D9C2FF]" />
          <div className="absolute left-1/2 top-1/2 h-[42px] w-[2px] -translate-x-1/2 translate-y-[60px] bg-[#D9C2FF]" />
          <div className="absolute left-1/2 top-1/2 h-[2px] w-[72px] -translate-y-1/2 -translate-x-[108px] bg-[#D9C2FF]" />
          <div className="absolute left-1/2 top-1/2 h-[2px] w-[72px] -translate-y-1/2 translate-x-[36px] bg-[#D9C2FF]" />
