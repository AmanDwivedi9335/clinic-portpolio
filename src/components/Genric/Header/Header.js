					...
					<nav className="hidden text-[#282672] hover:text-[#0B137A] lg:flex items-center ml-auto gap-14 text-[15px] font-semibold text-[#0d0d0d]">
						...
						<div className="relative group">
							...
							<div className="absolute left-0 top-full hidden group-hover:block group-focus-within:block w-[145px] rounded-2xl bg-white shadow-xl border p-3">
								<a className="block rounded-xl py-1  hover:bg-gray-50" href="/resources#resources1">ABHA / ABDM</a>
								<a className="block rounded-xl py-1 hover:bg-gray-50" href="/resources#resources2">Health Guides</a>
								<a className="block rounded-xl py-1 hover:bg-gray-50" href="/resources#resources3">Blog</a>
								<a className="block rounded-xl py-1 hover:bg-gray-50" href="/resources#resources4">Privacy policy</a>
							</div>
						</div>
						...
						<div className="relative group">
							...
							<div className="absolute right-0 top-full hidden group-hover:block group-focus-within:block w-[100px] rounded-2xl bg-white shadow-xl border p-3">
								<a className="block rounded-xl py-1 hover:bg-gray-50" href="/about#about1">Our Story</a>
								<a className="block rounded-xl py-1 hover:bg-gray-50" href="/about#about2">Our Team</a>
								<a className="block rounded-xl py-1 hover:bg-gray-50" href="/about#about3">Careers</a>
								<a className="block rounded-xl py-1 hover:bg-gray-50" href="/about#about4">Contact Us</a>
							</div>
						</div>
